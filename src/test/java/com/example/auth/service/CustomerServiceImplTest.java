...
//
//    public CustomerServiceImpl userModelService = spy(new CustomerServiceImpl(customerRepository, modelMapper, passwordUtils, jwtTokenUtil, nullAwareBeanUtilsBean));
//
//    @Test
//    void TestSignupUser() {
//        //given
